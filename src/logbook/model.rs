...
#[derive(Serialize, Insertable, Deserialize, Debug, Selectable, Queryable, ToSchema, Identifiable, Associations, PartialEq)]
...
#[derive(Serialize, Deserialize, Queryable, QueryableByName, Insertable, Debug, Clone, Selectable)]
#[diesel(table_name = crate::schema::loginfo)]
